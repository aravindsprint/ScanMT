...
export class ModalComponent implements OnInit {
  ...
  update(){
     ...
     console.log("updatefavStock",updatefavStock);
     this.favoriteService.getAllFavoriteStock().then(result => {
     console.log("result of fav stocks",result);
     console.log("type result of fav stocks",typeof(result));
     this.result = result;
     if(this.result == null){
      ...
      for(var i = 0; i < this.result.length; i++){
         ...
         //console.log("",result[i].change_batch_status);
